...
<head>
  ...
  <script src="<?php echo e(asset('js/export-excel.min.js')); ?>"></script>
  <script src="<?php echo e(asset('row_merger/dist/row-merge-bundle.min.js')); ?>"></script>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <?php endif; ?>
                  <form class="row g-3" action="<?php echo e(route('registerUser')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="col-12">
...
</html><?php /**PATH C:\Users\rumey\OneDrive\Masaüstü\rumi4\resources\views/register.blade.php ENDPATH**/ ?>